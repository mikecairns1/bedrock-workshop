# 1 Open embeddings_search_lib.py
# 2 import statements
import os
...
# 3 Add function to create the in-memory vector store
...
# 4 Add function to call bedrock
...
# 5 Add function to call raw embeddings for the query
