...
# 3 Create Helper function to get Inference parameters
...
# 4 Build function to call Bedrock with inference parameters 
...
# 5 Pass the commnd line parameters to the get_text_response function
